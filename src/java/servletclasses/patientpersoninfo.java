...
@WebServlet(name = "patientpersoninfo", urlPatterns = {"/patientinfo"})
@MultipartConfig(maxFileSize = 16177215)    // upload file's size up to 16MB
public class patientpersoninfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet patientpersoninfo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet patientpersoninfo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//String photo= request.getParameter("photo");
 ...
 //================================
            ...
            pstmt = conn.prepareStatement("insert into patientinfo values(?,?,?,?,?,?,?,?,?,?,?)");
